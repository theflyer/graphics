...
const QMetaObject HW3b::staticMetaObject = {
    { &HW::staticMetaObject, qt_meta_stringdata_HW3b.data,
      qt_meta_data_HW3b,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HW3b::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HW3b.stringdata0))
        return static_cast<void*>(const_cast< HW3b*>(this));
