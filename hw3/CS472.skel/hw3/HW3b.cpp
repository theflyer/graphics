...
HW3b::resizeGL(int w, int h)
{
    ...
    m_projection.perspective(45.0f, aspect, 0.01f, 100.f);
}
...
HW3b::initShaders()
{
	...
	initShader(TEX_SHADER, QString(":/hw3/vshader3b1.glsl"), QString(":/hw3/fshader3b1.glsl"), uniforms);
	...
	// compile shader, bind attribute vars, link shader, and initialize uniform var table
	initShader(FLAT_SHADER, QString(":/hw3/vshader3b3.glsl"), QString(":/hw3/fshader3b3.glsl"), uniforms);
